...
## 1. Usage
All you need is one file and a web server. Put [`roofpig_and_three.min.js`](https://raw.githubusercontent.com/dunkelziffer/Roofpig/fork/roofpig_and_three.min.js) on your server. Include it, and jQuery 3.1.1 in your HTML:
